                    ...
                    <div class="row">
                        <div class="image-container">
                            <div class="main-image">
                                <img src="img_descargadas/<?= $fetch_product['image_01']; ?>" alt="">
                            </div>
                            <div class="sub-image">
                                <img src="img_descargadas/<?= $fetch_product['image_01']; ?>" alt="">
                                <img src="img_descargadas/<?= $fetch_product['image_02']; ?>" alt="">
                                <img src="img_descargadas/<?= $fetch_product['image_03']; ?>" alt="">
                            </div>
                        </div>
                        ...
                        <div class="content">
                            ...
                            <div class="flex-btn">
                                ...
                                <input type="submit" value="Añadir a favoritos" name="add_to_wishlist" class="btn-green">
                            </div>
                        </div>
                </form>
